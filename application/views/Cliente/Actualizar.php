    ...
    <div class="row justify-content-center">
        <div class="col-xl-8 col-lg-8 col-md-12 col-sm-12 col-12 col-xl-offset-2">
            <div class="card">
                ...
                <?php echo form_open_multipart('cliente/actualizar/'.$datashow->id); ?>
                <div class="card-body">
                    ...
                    <div class="form-row">
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mb-2">
                            ...
                            <input type="text" class="form-control" id="nombre" name="nombre"  value="<?php echo $datashow->nombre ?>" placeholder="Digite un Nombre" autocomplete="off">
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mb-2">
                            <label for="apellido">Apellido</label>
                            <?php echo form_error('apellido', '<div class="alert alert-danger">', '</div>'); ?>
                            <input type="text" class="form-control" id="apellido" name="apellido" value="<?php echo $datashow->apellido ?>" placeholder="Digite un Apellido" autocomplete="off">
                        </div>
                    </div>
                    <div class="form-row">                        
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mb-2">
                            ...
                            <input type="text" class="form-control" id="cedula" name="cedula"  value="<?php echo $datashow->cedula ?>" placeholder="Digite el Numero de Cedula" autocomplete="off">
                        </div>
                        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 mb-2">
                    ...
                    <li class="list-group-item">
                        <div class="row">  
                            <div class="col-xl-12 col-lg-12 col-md-12">
                                <h5 class="mb-0">Actualizar Datos de la Tarjeta de Credito</h5>
                                <div class="switch-button switch-button-xs">
                                    <input type="checkbox" onchange="handleChange(this)" name="isEnabledUpdate" id="isEnabledUpdate" <?php echo ($isEnabledUpdate == "1")?"checked":"" ?>><span>
                                    <label for="isEnabledUpdate"></label></span>
                                </div>
                            </div> 
                        </div>
                    </li>
                    <li class="list-group-item" id="formInformacionTarjeta" <?php echo ($isEnabledUpdate == "1")?"style='display: '":"style='display: none'" ?>>
                        <div class="form-row">
...
<script>    
    function handleChange(checkbox) 
    {
        ...
        {
            //alert("prendido");
            document.getElementById("formInformacionTarjeta").style.display = "";
        }
        else
        {
            //alert("apagado");
            document.getElementById("formInformacionTarjeta").style.display = "none";
        }
    }
</script>
