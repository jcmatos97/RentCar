...
<div>
    ...
    <div class="row justify-content-center">
        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 col-xl-offset-3">
            <div class="card">
                <h5 class="card-header">Actualizar Tipo de Combustible</h5>
                <?php echo form_open('tipocombustible/actualizar/'.$datashow->id); ?>
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input id="nombre" name="nombre" placeholder="Actualice el Tipo de Combustible" type="text" class="form-control" value="<?php echo $datashow->nombre ?>" autocomplete="off">
                        </div>
                    </div>
