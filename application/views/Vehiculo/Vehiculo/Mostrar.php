                                    ...
                                    if(isset($datashow))
                                    {
                                        if (count($datashow) > 0)
                                        {
                                            foreach ($datashow as $value) {
                                                ...
                                                echo "<a class='btn btn-sm btn-outline-light' href='/rentcar/vehiculo/actualizar/".$value->id."'>Actualizar</a>";
                                                echo "<a class='btn btn-sm btn-outline-light' href='/rentcar/vehiculo/detalle/".$value->id."'>";
                                                echo "<i class='fas fa-search'></i>";
                                                echo "</a>";
                                                echo "<a class='btn btn-sm btn-outline-light' href='/rentcar/vehiculo/eliminar/".$value->id."' onclick='return confirm(`¿Esta seguro que desea eliminar este registro?`);'>";
