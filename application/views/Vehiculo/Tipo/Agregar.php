...
<div>
        ...
        <div class="row justify-content-center">
            <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 col-xl-offset-3">
                <div class="card">
                    <h5 class="card-header">Agregar Tipo de Vehiculo</h5>
                    <?php echo form_open('tipovehiculo/agregar'); ?>
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input id="nombre" name="nombre" placeholder="Digite un Tipo de Vehiculo" type="text" class="form-control" autocomplete="off">
                            </div>
                        </div>
