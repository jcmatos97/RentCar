...
<div>
    ...
    <div class="row justify-content-center">
        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 col-xl-offset-3">
            <div class="card">
                <h5 class="card-header">Actualizar Modelo de Vehiculo</h5>
                <?php echo form_open('modelovehiculo/actualizar/'.$datashow->id); ?>
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input id="nombre" name="nombre" placeholder="Digite un Modelo de Vehiculo" value="<?php echo $datashow->modelovehiculo ?>" type="text" class="form-control" autocomplete="off">
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control" name="tipovehiculo">
                                <?php
                                    ...
                                    {
                                        echo ($tipo->id == $datashow->id_tipovehiculo)?'<option value="'.$tipo->id.'" selected>'.$tipo->nombre.'</option>':'<option value="'.$tipo->id.'">'.$tipo->nombre.'</option>';
                                    }
                                ?>
                            </select>
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control" name="marcavehiculo">
                                ...
                                <?php
                                    ...
                                    {
                                        echo ($marca->id == $datashow->id_marcavehiculo)?'<option value="'.$marca->id.'" selected>'.$marca->nombre.'</option>':'<option value="'.$marca->id.'">'.$marca->nombre.'</option>';
                                    }
                                ?>
                            </select>
                        </div>
